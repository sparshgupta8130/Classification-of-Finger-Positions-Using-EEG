...
fileout = 'Data\Finger\Training\de_features.xlsx';
...
for k = 1:dat_de_ind_on
    ...
    for j = 1:10
        ...
        if j == 3 || j == 4
            for i = 1:f
                traindat_de(l,dat_de_ind_off+k) = num(i,j);
                l = l + 1;
            end
        end
    end
...
for k = 1:dat_de_mid_off
    ...
    for j = 1:10
        ...
        if j == 3 || j == 4
            for i = 1:f
                traindat_de(l,dat_de_ind_off+dat_de_ind_on+k) = num(i,j);
                l = l + 1;
            end
        end
    end
...
for k = 1:dat_de_mid_on
    ...
    for j = 1:10
        ...
        if j == 3 || j == 4
            for i = 1:f
                traindat_de(l,dat_de_ind_off+dat_de_ind_on+dat_de_mid_off+k) = num(i,j);
                l = l + 1;
            end
        end
    end
...
for k = 1:dat_de_thu_off
    ...
    for j = 1:10
        ...
        if j == 3 || j == 4
            for i = 1:f
                traindat_de(l,dat_de_ind_off+dat_de_ind_on+dat_de_mid_off+dat_de_mid_on+k) = num(i,j);
                l = l + 1;
            end
        end
    end
...
for k = 1:dat_de_thu_on
    ...
    for j = 1:10
        ...
        if j == 3 || j == 4
            for i = 1:f
                traindat_de(l,dat_de_ind_off+dat_de_ind_on+dat_de_mid_off+dat_de_mid_on+dat_de_thu_off+k) = num(i,j);
                l = l + 1;
            end
        end
    end
...
fileout = 'Data\Finger\Training\god_features.xlsx';
